...
const kpis = [
  ...
  { label: 'Converted', value: '54' },
  { label: 'Conversion', value: '29.7%' }
]
...
const details = ref([
  { source: 'Website', leads: '62', qualified: '28', quoted: '19', converted: '16', rate: '25.8%' },
  { source: 'Walk-in', leads: '54', qualified: '24', quoted: '20', converted: '19', rate: '35.2%' },
  { source: 'Social Media', leads: '41', qualified: '12', quoted: '8', converted: '6', rate: '14.6%' },
  { source: 'Referral', leads: '25', qualified: '17', quoted: '15', converted: '13', rate: '52.0%' }
])
</script>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0">
      <div>
        <div class="text-[10px] text-gray-500 mb-1">
          Super Admin / Analytics / Reports / <span class="font-bold text-gray-800">CRM Report</span>
        </div>
        <h1 class="text-[32px] tracking-tight font-bold text-gray-900">CRM Report</h1>
        <p class="text-sm text-gray-500 mt-1">Operational crm report with branch and date filters.</p>
      </div>
        ...
        <div class="h-44 flex items-center justify-center p-2 bg-[#fcfdfd] rounded-lg">
          <svg class="w-full h-full" viewBox="0 0 400 120" preserveAspectRatio="none">
            <polyline
              ...
              points="10,95 70,88 140,82 210,76 280,68 350,58 390,52"
            />
          </svg>
        </div>
      </div>
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="bg-[#fbfbfc] border-b border-gray-100 text-[10px] font-bold text-gray-400 uppercase tracking-wider">
              ...
              <th class="px-6 py-3">Qualified</th>
              <th class="px-6 py-3">Quoted</th>
              <th class="px-6 py-3">Converted</th>
          ...
          <tbody class="text-[11px]">
            ...
            >
              <td class="px-6 py-4 font-semibold text-gray-900">{{ item.source }}</td>
              <td class="px-6 py-4 text-gray-900 font-bold">{{ item.leads }}</td>
              <td class="px-6 py-4 text-gray-600 font-medium">{{ item.qualified }}</td>
              <td class="px-6 py-4 text-gray-600 font-medium">{{ item.quoted }}</td>
              <td class="px-6 py-4 text-gray-600 font-medium">{{ item.converted }}</td>
              <td class="px-6 py-4 text-gray-900 font-bold text-[#165A31]">{{ item.rate }}</td>
            </tr>
          </tbody>
        </table>
      </div>
